              ...
              <div className="relative flex items-center">
                <div className="flex flex-col items-start justify-center">
                  <div className="relative flex items-center justify-center">
                    <h1 className="flex items-center justify-center text-4xl font-bold tracking-tight text-[#4CAF50] font-montserrat">
                      Nutra
                    </h1>
                  </div>
                  <p className="text-xs font-poppins font-bold leading-relaxed text-[#39833C] mt-0.5">
                    Bahan Tersegar, Gizi Terjamin
                  </p>
                </div>
              </div>
            </div>
